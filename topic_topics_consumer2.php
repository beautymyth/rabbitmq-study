...
//队列名
$strQueue = 'queue_topic_topics_*.*.iphone_computer#';

//消费者标识
$strConsumerTag = 'consumer_topic_topics';
...
//将交换器与队列进行绑定
//同时绑定2个routekey
$objChannel->queue_bind($strQueue, $strExchange, '*.*.iphone');
$objChannel->queue_bind($strQueue, $strExchange, 'computer.#');
