...
use Lib\PhpAmqpLib\Channel\AbstractChannel;
use Lib\PhpAmqpLib\Exception\AMQPProtocolConnectionException;
use Lib\PhpAmqpLib\Exception\AMQPRuntimeException;
use Lib\PhpAmqpLib\Exception\AMQPTimeoutException;
use Lib\PhpAmqpLib\Wire\AMQPReader;
use Lib\PhpAmqpLib\Wire\AMQPTable;
use Lib\PhpAmqpLib\Wire\AMQPWriter;
use Lib\PhpAmqpLib\Wire\IO\AbstractIO;
use Lib\PhpAmqpLib\Wire\IO\SocketIO;
use Lib\PhpAmqpLib\Wire\IO\StreamIO;
...
class AbstractConnection extends AbstractChannel {
    ...
    /** @var \Lib\PhpAmqpLib\Wire\IO\AbstractIO */
    protected $io;
     ...
     * @throws \Lib\PhpAmqpLib\Exception\AMQPProtocolConnectionException
     */
    ...
    /**
     * @return \Lib\PhpAmqpLib\Wire\IO\AbstractIO
     */
