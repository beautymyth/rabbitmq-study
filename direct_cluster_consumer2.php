...
/**
 * 1.在rabbitmq_node3上获取rabbitmq_node1上队列的消息
 */
...
//消费者标识
$strConsumerTag = 'consumer_direct_cluster_node3';
 ...
 */
$objConnection = new AMQPStreamConnection('10.100.2.235', 5672, 'admin', 'admin');
